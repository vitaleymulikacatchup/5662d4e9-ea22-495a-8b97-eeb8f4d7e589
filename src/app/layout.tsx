...
export const metadata: Metadata = {
  title: "The Daily Brew - Premium Coffee Shop",
  description: "Specialty coffee, pastries, and cozy ambiance. Visit us for the finest coffee experience in downtown.",
  keywords: ["coffee shop", "espresso", "specialty coffee", "cafe", "barista"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "The Daily Brew - Premium Coffee Shop",
    description: "Specialty coffee, pastries, and cozy ambiance. Visit us for the finest coffee experience.",
    siteName: "The Daily Brew",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1764332267291-jvs5c6e4.jpg",
        alt: "The Daily Brew Coffee Shop",
      },
    ],
  },
  twitter: {
    ...
    title: "The Daily Brew - Premium Coffee Shop",
    description: "Experience specialty coffee in a cozy downtown atmosphere",
  },
};
